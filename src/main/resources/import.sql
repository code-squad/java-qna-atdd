...
INSERT INTO question (id, writer_id, title, contents, create_date, deleted) VALUES (3, 2, 'expected delete', 'expected delete contents', CURRENT_TIMESTAMP(), false);

INSERT INTO question (id, writer_id, title, contents, create_date, deleted) VALUES (4, 2, 'expected update', 'expected update contents', CURRENT_TIMESTAMP(), false);