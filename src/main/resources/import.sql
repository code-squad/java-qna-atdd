INSERT INTO user (id, user_id, password, name, email, created_at) values (1, 'kuro', 'test', '쿠로', 'kuro@slipp.net', CURRENT_TIMESTAMP());
INSERT INTO user (id, user_id, password, name, email, created_at) values (2, 'dsoop', 'test', '대숲', 'dsoop@slipp.net', CURRENT_TIMESTAMP());
