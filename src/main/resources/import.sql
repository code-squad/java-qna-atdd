...
INSERT INTO user (id, user_id, password, name, email) values (3, 'jimmy', '12345', '지미', 'jaeyeon93@naver.com');
INSERT INTO user (id, user_id, password, name, email) values (4, 'jaeyeon', '12345', '재연', 'jaeyeon93@naver.com');
...
INSERT INTO question (id, writer_id, title, contents, create_date, deleted) VALUES (3, 3, '제목1111', 'content insert ', CURRENT_TIMESTAMP(), false);
INSERT INTO question (id, writer_id, title, contents, create_date, deleted) VALUES (4, 1, '로그인 default', '댓글 없음', CURRENT_TIMESTAMP(), false);
INSERT INTO question (id, writer_id, title, contents, create_date, deleted) VALUES (5, 1, '로그인 default', '댓글작성자 로그인유저랑 같음', CURRENT_TIMESTAMP(), false);
INSERT INTO question (id, writer_id, title, contents, create_date, deleted) VALUES (6, 3, '글쓴이 jimmy', '댓글작성자 여러명', CURRENT_TIMESTAMP(), false);
...
INSERT INTO answer (writer_id, contents, create_date, question_id, deleted) VALUES (3, 'jimmy가 쓴 댓글', CURRENT_TIMESTAMP(), 1, false);
