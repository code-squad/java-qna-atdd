...
public class UserTest extends BaseTest {
    ...
    public static User user = new User(1L, "javajigi", "password", "name", "javajigi@slipp.net");
    public static User other = new User(2L, "sanjigi", "password", "name", "sanjigi@slipp.net");
