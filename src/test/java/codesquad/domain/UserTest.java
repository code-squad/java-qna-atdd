...
public class UserTest extends BaseTest {
    public static final User JAVAJIGI = new User(1L, "javajigi", "test", "자바지기", "javajigi@slipp.net");
    public static final User SANJIGI = new User(2L, "sanjigi", "test", "산지기", "sanjigi@slipp.net");
