...
public class UserAcceptanceTest extends AcceptanceTest {
    ...
    public void create() throws Exception {
        ...
        ResponseEntity<String> response = template().postForEntity("/users", builder.getOrPost(), String.class);
    ...
    private ResponseEntity<String> update(TestRestTemplate template) throws Exception {
        ...
        return template.postForEntity(String.format("/users/%d", defaultUser().getId()), builder.getOrPost(), String.class);
    }
